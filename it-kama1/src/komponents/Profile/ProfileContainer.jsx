...
import {getUser, setUserProfile, toggleIsFetching} from "../../redux/profile-reducer";
...
export default connect(mapStateToProps, {setUserProfile, toggleIsFetching, getUser})(WithRouterProfileContainer);
